...
const FirstPageEditSolicitationForm: React.FC<Props> = ({ values, setValues }) => {
  ...
  const handleChange = (field: keyof UpdateSolicitationFormDataInterface) => (text: string | number) => {
...
export default FirstPageEditSolicitationForm;